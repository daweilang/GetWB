...
class AuthorizeController extends Controller
{
    ...
    {	
    	$preParam = [	
     			'servertime' => $request->get('servertime'),
    			'nonce' => $request->get('nonce'),
    			'pubkey' => $request->get('pubkey'),
    			'rsakv' => $request->get('rsakv'),
    	];
...
// 			document.write(encrpt);
			window.location.href='/admin/authorize/getCookie/?sp='+encrpt+'&servertime={$preParam['servertime']}&nonce={$preParam['nonce']}&rsakv={$preParam['rsakv']}';  
	</script>";
    		return ;
...
// 				var encrpt = getpass('".$preParam['sp']."', ".$preParam['servertime'].", '".$preParam['nonce']."', '".$preParam['pubkey']."' );
// 			// 			window.location.href='/admin/authorize/getCookie/?sp='+encrpt+'&servertime={$preParam['servertime']}&nonce={$preParam['nonce']}&rsakv={$preParam['rsakv']}';
// 			url='/admin/authorize/getCookie/?sp='+encrpt+'&servertime={$preParam['servertime']}&nonce={$preParam['nonce']}&rsakv={$preParam['rsakv']}';
       		
// 			</script>";
// echo <<<EOT

// 	<form method='get' id='get_cookie' action=''>
// 		<img src="http://login.sina.com.cn/cgi/pin.php?r=87514507&s=0&p=xd-9b5b5d8096a1990aff860ac408eb7dbf7e29">
// 		<br>
// 		<input id='door' name='door' value='' type='text'>输入验证码
// 		<br>
// 		<a href="javascript:" id='gc_submit'>提交订单</a>
// 	</from>
	
// <script type='text/javascript'>
// 	$('#gc_submit').click(function() {
// 		$('#get_cookie').attr("action", url);
// 		alert(url);
// 		$('form').submit();
//     	return ;
// 	});
